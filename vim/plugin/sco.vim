...
let s:sco_settings = {}
let s:sco_requests = {0:'symbol', 1:'global',3:'calling',4:'text',6:'grep',7:'file', 8:'include'}
...
function! <SID>Prepare_sco_settings() "{{{
	...
	command! -nargs=1 SCOWhoCall call <SID>CScopeResult(3, <args>)
	command! -nargs=1 SCOText call <SID>CScopeResult(4, <args>)
